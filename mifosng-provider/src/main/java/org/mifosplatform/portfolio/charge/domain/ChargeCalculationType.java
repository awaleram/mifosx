...
public enum ChargeCalculationType {
    ...
    public static Object[] validValuesForLoan() {
        return new Integer[] { ChargeCalculationType.FLAT.getValue(), ChargeCalculationType.PERCENT_OF_AMOUNT.getValue(),
                ...
                ChargeCalculationType.PERCENT_OF_PRINCIPALE_AMOUNT.getValue(),
                ChargeCalculationType.PERCENT_OF_LOAN_PROPOSED_AMOUNT.getValue()};
    }
    ...
    public static ChargeCalculationType fromInt(final Integer chargeCalculation) {
        ...
        switch (chargeCalculation) {
            ...
            break;
            case 6:
            	chargeCalculationType =  PERCENT_OF_PRINCIPALE_AMOUNT;
            break;	
            case 7:
            	chargeCalculationType = PERCENT_OF_LOAN_PROPOSED_AMOUNT;
            break;	
        }
    ...
    public boolean isPercentageBased() {
        return isPercentageOfAmount() || isPercentageOfAmountAndInterest() || isPercentageOfInterest() || isPercentageOfDisbursementAmount()
        		|| isPercentageOfPrincipalAmount() || isPercentageOfLoanProposedAmount();
    }
    ...
    public boolean isPercentageOfPrincipalAmount(){
    	return this.value.equals(ChargeCalculationType.PERCENT_OF_PRINCIPALE_AMOUNT.getValue());
    }
    
    public boolean isPercentageOfLoanProposedAmount(){
    	return this.value.equals(ChargeCalculationType.PERCENT_OF_LOAN_PROPOSED_AMOUNT.getValue());
    }
}